...
const Footer = () => {
  return (
    <footer
      className="px-3 py-6 w-full transition-colors duration-200 text-gray-200"
      style={{
        direction: "ltr",
      }}
    >
      <div className="flex flex-col">
        ...
        <div className="flex flex-col mt-4 md:mt-0 md:flex-row">
          ...
          <div className="flex items-center gap-2 justify-center flex-1 mt-4 border-gray-100 md:mt-0 md:border-r">
            <a
              target="_new"
            ...
            <a
              target="_new"
              href="https://www.tiktok.com/@alkadome"
              className="text-gray-400 transition-colors duration-200 hover:text-white"
            >
              <svg
                width="30"
